...
class Blog(models.Model):
    ...
    YAYIN_TASLAK = ((None,"Lutfen Birini Seçiniz"),("yayin","YAYIN"),("taslak","TASLAK"))

    user = models.ForeignKey(User, default = 1, null = True, verbose_name = "User",related_name = "blog", on_delete = models.PROTECT)

    title = models.CharField(max_length=100,blank = False, null = True, verbose_name="başlık",help_text="Başlık bilgisi burada girilir.")

    content = RichTextField(null = True,blank = False,max_length = 5000, verbose_name = "içerik" )
    slug = models.SlugField(null=True, unique=True, editable = False)
    image = models.ImageField(default = 'Default/hqdefault.jpg',upload_to = upload_to , blank = True,verbose_name = "Resim",null = True,help_text = "Kapak Fotoğrafı yükleyiniz.")
    ...
    def get_favorite_count(self):
        favori_sayısı = self.favorite_blog.count()
        return favori_sayısı
    ...
    def get_image(self):
        if self.image:
            ...
            return "/media/Default/hqdefault.jpg"
    ...
    def get_blog_comment(self):
        #gönderiye ait bütün yorumları bana veren fonksiyon.
...
class Comment(models.Model):
    user = models.ForeignKey(User,null = True, default = 1, related_name = 'comment', on_delete = models.PROTECT)
    blog = models.ForeignKey(Blog, null = True, on_delete = models.PROTECT,related_name = "comment")
...
class NewComment(models.Model):
    user = models.ForeignKey(User, null=True, default=1, related_name='+', on_delete=models.PROTECT)
    is_parent = models.BooleanField(default = False)

    content_type = models.ForeignKey(to = ContentType, null = True, on_delete = models.PROTECT)
...
class FavoriteBlog(models.Model):
    user = models.ForeignKey(User, null = True, default = 1, related_name = 'favorite_blog', on_delete = models.PROTECT)
    blog = models.ForeignKey(Blog, null = True, related_name ='favorite_blog', on_delete = models.PROTECT)
